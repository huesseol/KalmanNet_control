...
class KalmanNetNN(torch.nn.Module):
    ...
    def Build(self, SysModel):
        ...
        self.InitSystemDynamics(SysModel.f, SysModel.h, SysModel.m, SysModel.p, SysModel.n, infoString = "partialInfo")
    ...
    ##################################
    def InitSystemDynamics(self, f, h, m, p, n, infoString = 'fullInfo'):
