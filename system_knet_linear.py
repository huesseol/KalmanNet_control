...
class KalmanNetNN(torch.nn.Module):
    ...
    def Build(self, SysModel):
        ...
        self.InitSystemDynamics(SysModel.F, SysModel.G, SysModel.H, SysModel.m, SysModel.p, SysModel.n, infoString = "partialInfo")
    ...
    ##################################
    def InitSystemDynamics(self, F, G, H, m, p, n, infoString = 'fullInfo'):
    ...
    def KNet_step(self, y, u):
        ...
        # Innovation
        # y_obs = y # torch.unsqueeze(y, 1) # TODO 
        dy = y - self.m1y
